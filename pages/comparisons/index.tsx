          ...
          <tbody>
            <tr className={styles.tr}>
              ...
              <>
                  ...
                  />
                  <div onClick={() => deleteFavorite(numberOfGood + 1)}>
                    <Trash width='30px' height='30px' color='#e86a23'/>
                  </div>
                </>
                  : null}</td> : null}
            ...
            <tr className={styles.tr}>
              ...
              <td className={styles.td}>
                <a className={styles.a} onClick={() => router.push(`${process.env.NEXT_PUBLIC_API_URL}country/${allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood]?.name.common.toLowerCase() 
                  : null}`)}>
                  {allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood]?.name.common 
                  : null}
                </a>
              </td>
              {favorites >= 2 ? 
              <td className={styles.td}>
                <a className={styles.a} onClick={() => router.push(`${process.env.NEXT_PUBLIC_API_URL}country/${allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood + 1]?.name.common.toLowerCase() 
                  : null}`)}>
                  {allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood + 1]?.name.common 
                  : null}
                </a>
              </td>
              : null}
              ...
              <td className={styles.td}>
                <a className={styles.a} onClick={() => router.push(`${process.env.NEXT_PUBLIC_API_URL}country/${allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood + 2]?.name.common.toLowerCase() 
                  : null}`)}>
                  {allComparisonGoods 
                  ? 
                  allComparisonGoods[numberOfGood + 2]?.name.common 
                  : null}
                </a>
              </td>
              : null}
            ...
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.region : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.region : null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.capital : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.capital : null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.subregion : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.subregion : null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? String(allComparisonGoods[numberOfGood + 1]?.latlng[0]) + ', ' + String(allComparisonGoods[numberOfGood + 1]?.latlng[1]): null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? String(allComparisonGoods[numberOfGood + 2]?.latlng[0]) + ', ' + String(allComparisonGoods[numberOfGood + 2]?.latlng[1]): null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              <td className={styles.td}>Area:</td>
              <td className={styles.td}>{allComparisonGoods ? allComparisonGoods[numberOfGood]?.area : null}</td>
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.area : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.area : null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.population : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.population : null}</td>: null}
            </tr>
            <tr className={styles.tr}>
              ...
              {favorites >= 2 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 1]?.timezones[0] : null}</td>: null}
              {favorites >= 3 ? <td className={styles.td}>
                {allComparisonGoods ? allComparisonGoods[numberOfGood + 2]?.timezones[0] : null}</td>: null}
            </tr>
          </tbody>
        </table>
        </div>
